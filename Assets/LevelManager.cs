...
public class LevelManager : MonoBehaviour
{
    ...
    private Vector2[] pyramidPositions = new Vector2[]
    {
        ...
        new Vector2(-60, 50), new Vector2(60, 50),
        // Third row (3 hexagons) - D, E, F
        new Vector2(-120, -50), new Vector2(0, -50), new Vector2(120, -50),
        // Bottom row (4 hexagons) - G, H, I, J
        new Vector2(-180, -150), new Vector2(-60, -150), new Vector2(60, -150), new Vector2(180, -150)
    };
